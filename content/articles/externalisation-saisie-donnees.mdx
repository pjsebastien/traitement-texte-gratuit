...
**Sociétés spécialisées offshore** : des entreprises basées à Madagascar, en Inde ou aux Philippines proposent des services de saisie à grande échelle. Les plus connues en francophonie : Mada-services, RunBPO, ou encore des agences malgaches spécialisées en BPO (Business Process Outsourcing). En France, une [entreprise spécialisée en saisie de données](https://www.saisie-donnees.fr/) comme Saisie-données.fr propose aussi ce type de prestation avec un cadre juridique plus simple.
